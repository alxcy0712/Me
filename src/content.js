export const content = {
  zh: {
    ...
    queueTitle: "正在形成的文章",
    footer: "一个持续编译中的个人系统。",
      machineHint: "悬停，展开因果 / HOVER TO UNFOLD",
      machineExpanded: "移开，重新合拢 / LEAVE TO CLOSE",
  },
  en: {
    ...
    footer: "A personal system, continuously compiling.",
      machineHint: "Hover to unfold causality / 悬停展开",
      machineExpanded: "Leave to close / 移开合拢",
  },
};
