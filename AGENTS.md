...
- The selected redesign direction is the “Causal Armillary.” `design/world-compiler-causal-armillary-closed.png` is the default endpoint, `design/world-compiler-causal-armillary-expanded.png` is the hover endpoint, and `design/world-compiler-expanded.png` remains the editorial layout and style reference.
...
- The armillary must reach the photographic material standard of the selected mock: broad beveled ring bands, visible metal layering, recessed fasteners, perforation depth, engraved micro-lines, and a mechanically detailed center bearing.
